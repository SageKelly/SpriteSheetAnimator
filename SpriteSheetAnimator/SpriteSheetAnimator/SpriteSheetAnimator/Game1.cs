...
namespace SpriteSheetAnimator
{
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        * change colors in an effort to reveal dangling pixels.
         ...
         */
        const int iSLOW_INC = 1000 / 10;
        const int iMED_INC = 1000 / 15;
        const int iFAST_INC = 1000 / 20;
        ...
        protected override void UnloadContent()
        {
             ...
             * method is called.
             */
            DirList.RemoveRange(0, DirList.Count);
            FilenameList.RemoveRange(0, FilenameList.Count);
        }
        #endregion
        #region Update()
        ...
        public void HandleStates(GameTime gameTime)
        {
            ...
            switch (AS)
            {
                ...
                case AnimStates.FolderSelection:
                    ...
                    {
                        if (FilenameList[iScrollbarOffset].PosY + 4 > graphics.PreferredBackBufferHeight / 2 ||
                            ...
                            if (iSelection == -1)
                            {
                                    ...
                                    (int)FilenameList[FilenameList.Count - 1].PosX, (int)FilenameList[FilenameList.Count - 1].PosY)))
                                {
                                    iTextOffset = (-(FilenameList.Count - 1) * iTEXT_SPACING) +
                                        graphics.PreferredBackBufferHeight - (iHEADER_SPACING * 2) - iTEXT_SPACING;
                                }
                            }
                        }
                        else
                    ...
                    if (Iinput.KBState.IsKeyDown(Keys.Up))
                    {
                        ...
                        if (RightButtonDownTime.TotalMilliseconds >= iDELAY)
                        {
                            if (RightButtonDownTime.TotalMilliseconds >= (iDELAY * 3))
                            {
                                if (RightButtonDownTime.TotalMilliseconds >= (iDELAY * 6))
                                {
                                    ButtonIncTime += gameTime.ElapsedGameTime;
                                    if (ButtonIncTime.TotalMilliseconds >= iFAST_INC)
                                    {
                                        if (FilenameList[iScrollbarOffset].PosY + 4 > graphics.PreferredBackBufferHeight / 2 ||
                                            ViewportRect.Contains(new Point((int)FilenameList[0].PosX, (int)FilenameList[0].PosY)))
                                        {
                                            iScrollbarOffset--;
                                            iSelection--;
                                            if (iScrollbarOffset == -1)
                                            {
                                                iScrollbarOffset = DirList.Count - 1;
                                                iSelection = DirList.Count - 1;
                                                if (!ViewportRect.Contains(new Point(
                                                    (int)FilenameList[FilenameList.Count - 1].PosX, (int)FilenameList[FilenameList.Count - 1].PosY)))
                                                {
                                        ...
                                        ButtonIncTime = new TimeSpan(0);
                                    }
                                    break;
                                }
                                ButtonIncTime += gameTime.ElapsedGameTime;
                                if (ButtonIncTime.TotalMilliseconds >= iMED_INC)
                                {
                                    if (FilenameList[iScrollbarOffset].PosY + 4 > graphics.PreferredBackBufferHeight / 2 ||
                                        ViewportRect.Contains(new Point((int)FilenameList[0].PosX, (int)FilenameList[0].PosY)))
                                    {
                            ...
                            ButtonIncTime += gameTime.ElapsedGameTime;
                            if (ButtonIncTime.TotalMilliseconds >= iSLOW_INC)
                            {
                                if (FilenameList[iScrollbarOffset].PosY + 4 > graphics.PreferredBackBufferHeight / 2 ||
                                    ViewportRect.Contains(new Point((int)FilenameList[0].PosX, (int)FilenameList[0].PosY)))
                                {
                    ...
                    {
                        RightButtonDownTime = new TimeSpan(0);
                    }
                    #endregion
                    ...
                    if (Iinput.KBState.IsKeyDown(Keys.Down))
                    {
                        RightButtonDownTime += gameTime.ElapsedGameTime;
                        if (RightButtonDownTime.TotalMilliseconds >= iDELAY)
                        {
                                ...
                                if (RightButtonDownTime.TotalMilliseconds >= (iDELAY * 6))
                                {
                                    ...
                                    if (ButtonIncTime.TotalMilliseconds >= iFAST_INC)
                                    {
                                                ...
                                                (int)FilenameList[FilenameList.Count - 1].PosY)))
                                        {
                                            iSelection++;
                                            iScrollbarOffset++;
                                            if (iScrollbarOffset == DirList.Count)
                                            {
                                                iScrollbarOffset = 0;
                                                iSelection = 0;
                                                iTextOffset = 0;
                ...
                case AnimStates.GraphicsSelection:
                    ...
                    if (Iinput.KBState.IsKeyDown(Keys.Up))
                    {
                        ...
                        if (UpButtonDownTime.TotalMilliseconds >= iDELAY)
                        {
                            if (UpButtonDownTime.TotalMilliseconds >= (iDELAY * 3))
                            {
